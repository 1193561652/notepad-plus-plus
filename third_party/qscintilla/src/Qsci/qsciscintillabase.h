...
public:
    ...
    //! Send a message using pointer-width integer parameters and return value.
    qintptr SendScintillaNpp(unsigned int msg, quintptr wParam = 0,
            qintptr lParam = 0) const;

    //! Send a parameterized message that returns a pointer.
    void *SendScintillaPtrResult(unsigned int msg, quintptr wParam,
            qintptr lParam) const;
